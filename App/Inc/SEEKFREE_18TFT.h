...
#define DC_PIN	        PTA17//B17	//液晶命令位硬件定义		
#define REST_PIN	PTB16//B16 //液晶复位引脚定义
...
extern  uint16 PENCOLOR;
extern  uint16 BGCOLOR;
...
//extern const unsigned char gImage_car[3120];
